...
def create_clip_model(device):
    model, preprocess_train = open_clip.create_model_and_transforms(
        'ViT-H-14-quickgelu',
        device=device,
        pretrained="dfn5b",
...
def main():
    ...
    model_path = "/scratch/data/m23csa016/meesho_data/checkpoints/clipvit_large/vith14_quickgelu_fulltrain/vith14_quickgelu_fulltrain_3_trainval_211642.pth"
    output_csv_path = "/iitjhome/m23csa016/meesho_code/results/vith14_quickgelu_fulltrain_3_trainval_211642.csv"
