...
def setup_logging(log_dir="logs_e40"):
    ...
    log_file = os.path.join(log_dir, f'ht_final10k_{timestamp}.log')
    ...
    try:
        for epoch in epoch_pbar:
            ...
            if val_acc > best_val_accuracy:
                ...
                # Save the checkpoint
                checkpoint_dir = '/scratch/data/m23csa016/meesho_data/checkpoints/clipvit_large/ht_final10k_e40'
                os.makedirs(checkpoint_dir, exist_ok=True)
                
                save_path = os.path.join(checkpoint_dir, f'ht_final10k_{epoch+1}_{datetime.now().strftime("%Y%m%d_%H%M%S")}.pth')
...
def main():
    ...
    try:
        ...
        train_csv = os.path.join(DATA_DIR, "final_10k.csv")
