...
TEST_IMG_DIR = os.path.join(DATA_DIR, "train_images")
...
adapter_paths = {
    'women_group_attrs': {
        'model': os.path.join(FINETUNING_DIR, "women_group_attrs/checkpoint-700"),
        'csv_path': os.path.join(CSV_DIR, "women_group_attrs_1_missing.csv"),
        'pred_dir': os.path.join(CODE_DIR, "women_group_attrs_fine/pred")
    }
}

category_prompts = {
    "Women Tshirts": "Given this product image of 'Women Tshirts' category, what are fit_shape, sleeve_length, sleeve_styling, length of the product?",
    "Women Tops & Tunics": "Given this product image of 'Women Tops & Tunics' category, what are fit_shape, sleeve_length, sleeve_styling, length of the product?",
    "Kurtis": "Given this product image of 'Kurtis' category, what are fit_shape, sleeve_length, sleeve_styling, length of the product?"
}
