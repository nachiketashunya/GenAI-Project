...
class CategoryAwareAttributePredictor(nn.Module):
    ...
    def forward(self, clip_features, categories):
        results = {}
...
def train_model(model, train_loader, device, train_dataset, num_epochs=10):
    ...
    for epoch in epoch_pbar:
        ...
        for images, categories, targets in train_pbar:
            ...
            predictions = model(clip_features, categories)
            ...
            train_pbar.set_postfix({
                ...
                'batch_acc': f'{sum(batch_correct.values()) / max(sum(batch_total.values()), 1):.2%}'
            })
        ...
        if epoch % 5 == 0:
            ...
            }, f'/scratch/data/m23csa016/meesho_data/checkpoints/clipvit_large_combined/clipvit_unfreeze_70k_{epoch}.pth')
...
def main():
    ...
    torch.save({
        ...
        'attribute_encoders': train_dataset.attribute_encoders,
        'category_mapping': category_class_attribute_mapping
    }, '/scratch/data/m23csa016/meesho_data/checkpoints/clipvit_large_combined/clipvit_unfreeze_70k.pth')
