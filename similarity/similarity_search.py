...
train_features_df = pd.read_parquet('/scratch/data/m23csa016/meesho_data/embeddings/cvl_uf_ht_2_70k_train_em_1.parquet')
test_features_df = pd.read_parquet('/scratch/data/m23csa016/meesho_data/embeddings/cvl_uf_ht_2_70k_test_em_1.parquet')
...
results_df[submission_columns].to_csv('cvl_uf_ht_2_70k_K10_results.csv', index=False)
