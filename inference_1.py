...
adapter_paths = {
    'universal_attrs': {
        'model': os.path.join(FINETUNING_DIR, "universal_attrs/checkpoint-1600"),
        'csv_path': os.path.join(CSV_DIR, "universal_attrs_1_missing.csv"),
        'pred_dir': "/iitjhome/m23csa016/meesho_code/universal_attrs_fine/pred"
    }
}

category_prompts = {
    "Women Tshirts": "Given this product image of 'Women Tshirts' category, what are color, pattern, print_or_pattern_type of the product?",
    "Women Tops & Tunics": "Given this product image of 'Women Tops & Tunics' category, what are color, pattern, print_or_pattern_type of the product?",
    "Kurtis": "Given this product image of 'Kurtis' category, what are color, pattern, print_or_pattern_type of the product?",
    "Men Tshirts": "Given this product image of 'Men Tshirts' category, what are color, pattern, print_or_pattern_type of the product?",
    "Sarees": "Given this product image of 'Sarees' category, what are color, pattern, print_or_pattern_type of the product?"
}
